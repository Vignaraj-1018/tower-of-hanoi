...
export default function RootLayout({
  ...
  const sendViewAnalytics=()=>{
    ...
    const data ={
      "name":"Tower of Hanoi",
      "url":"https://tower-of-hanoi.vignaraj.in/"
    }
    axios.post(url,data)
    .then((resp:any)=>{
      // console.log(resp);
      ...
      <body className="flex h-[100dvh] w-full flex-col justify-between bg-primary">
        ...
        <footer>
          <div className="flex flex-row h-8 bg-secondary text-black items-center justify-center">
              <p className="flex text-sm font-semibold gap-1">© Out of passion by, <a href="https://api.vignaraj.in/redirect_links/redirect/6691475f7d0ad6b43299e5b9" target="_blank" className="flex">Vignaraj D</a></p>
          </div>
        </footer>
      </body>
    </html>
