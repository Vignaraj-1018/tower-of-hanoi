...
export default function Play() {
    ...
    return (
        <div className="flex w-full h-full items-center p-10 gap-10 flex-col overflow-auto">
            ...
            <div className="flex text-3xl font-semibold">Welcome! Get ready to stack, move, and win!</div>
            ...
            <div className="flex bg-accent hover:shadow-xl text-3xl font-semibold p-2 rounded-lg cursor-pointer select-none text-white" onClick={handleStart}>Start</div>

            <div className="flex flex-col gap-2 p-4 rounded-lg border-2 border-accent sm:w-2/3">
              
              <p className="flex underline underline-offset-2 text-2xl font-semibold justify-center">Help</p>
              <details open>
                <summary className="font-semibold underline underline-offset-2 cursor-pointer">How to play?</summary>
              ...
              <details>
                <summary className="font-semibold underline underline-offset-2 cursor-pointer">How score is calculated?</summary>
                <div className="flex flex-col gap-2">
              ...
              <details>
                <summary className="font-semibold underline underline-offset-2 cursor-pointer">Origin of the game</summary>
                <div className="flex flex-col gap-2">
